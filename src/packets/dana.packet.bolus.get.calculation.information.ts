...
export const CommandBolusGetCalculationInformation =
  ((DANA_PACKET_TYPE.TYPE_RESPONSE & 0xff) << 8) + (DANA_PACKET_TYPE.OPCODE_BOLUS__GET_CALCULATION_INFORMATION & 0xff);
