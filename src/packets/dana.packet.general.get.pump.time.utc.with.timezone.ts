...
export const CommandGeneralGetPumpTimeUtcWithTimezone =
  ((DANA_PACKET_TYPE.TYPE_RESPONSE & 0xff) << 8) + (DANA_PACKET_TYPE.OPCODE_OPTION__GET_PUMP_UTC_AND_TIME_ZONE & 0xff);
