...
export function generatePacketAPSSetEventHistory(options: PacketAPSSetEventHistory): DanaGeneratePacket {
...
export function parsePacketAPSSetEventHistory(data: Uint8Array): DanaParsePacket {
	return {
